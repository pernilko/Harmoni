            ...
            <Accordion>
                <Card style={{border: "none"}}>
                    <Card.Header style={{border: "none"}}>
                        ...
                        <button type="button" className="btn btn-danger" style={{marginLeft: 10+"px", float: "left"}} onClick={() => this.deleteEmployee(this.props.employee)}>Slett</button>
                    </Card.Header>
                                    ...
                                    <row>
                                        ...
                                        <div className="form-group">
                                            ...
                                            <select className="form-control" id="userSelect">
                                                {this.users.map(user => (
                                                    <option value={user.user_id} selected={true}>{user.user_name}</option>
                                                ))}
                                            </select>
                                        </div>
                                        <div className="form-group">
                                            <label>Stilling </label>
                                            <input type="text" className="form-control" placeholder="stilling" value={this.position}
    ...
    mounted() {
        ...
        userService
            ...
            .then(res => {this.users = res;
                console.log("hei"+this.users[0].user_name)})
